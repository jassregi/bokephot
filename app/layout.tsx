...
export const metadata: Metadata = {
    ...
    metadataBase: new URL("https://bokephot.pages.dev"),
    alternates: {
        canonical: `/`,
    },
    openGraph: {
    ...
    verification: {
        google: 'd8lUVs9RtElGxl0ZfFqEdXoiqRe7U1E7hYnKXbemYY0',
        yandex: 'dd5f2eaa06848126',
    },
};
...
export default function RootLayout({
    ...
    const jsonLd = {
        ...
        "name": `${SITENAME}`,
        "description": `${SITENAME} Video bokep indo jepang indonesia barat terbaru viral korea simontok china tante live sma paksa ngentot abg jilbab cewek bocil smp pijat pelajar.`,
        "logo": "https://bokephot.pages.dev/favicon.ico",
        "url": "https://bokephot.pages.dev",
        "founder":{
            "@type":"Person",
            "name":"admin",
            "url":"https://bokephot.pages.dev"
        ...
        "url": "https://bokephot.pages.dev",
        "description": `${SITENAME} Video bokep indo jepang indonesia barat terbaru viral korea simontok china tante live sma paksa ngentot abg jilbab cewek bocil smp pijat pelajar.`,
        "image": "https://bokephot.pages.dev/favicon.ico",
        "potentialAction":{
            "@type":"ReadAction",
            "target":"https://bokephot.pages.dev"}
        }
        const jsonLd2 = {
            "@context": "https://schema.org",
        "@type": "WebSite",
        ...
        "potentialAction": { 
        "@type": "SearchAction", 
          "target": "https://bokephot.pages.dev/?q={search_term}", 
